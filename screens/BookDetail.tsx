...
import { Animated, Image, ImageBackground, ScrollView, Text, TouchableOpacity, View } from "react-native";
...
export const BookDetail: React.FC<BookDetailProps> = ({ route, navigation }) => {
  const LineDivider = () => {
    return (
